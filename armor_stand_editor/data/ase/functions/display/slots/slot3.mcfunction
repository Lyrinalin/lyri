...
execute at @e[type=armor_stand,tag=ase.selected,limit=1,sort=nearest,distance=..6] run summon item_display ~ ~ ~ {Tags:["ase.display","ase.slot3","ase.tmp"],item:{id:"minecraft:stone",count:1},transformation:{translation:[0f,0.5f,0f],scale:[1f,1f,1f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
