...
execute at @e[type=armor_stand,tag=ase.selected,limit=1,sort=nearest,distance=..6] run summon item_display ~ ~ ~ {Tags:["ase.display","ase.preset","ase.tmp"],item:{id:"minecraft:stone",count:1,components:{"minecraft:custom_model_data":1001}},transformation:{translation:[0f,1.0f,0f],scale:[1.2f,1.2f,1.2f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
